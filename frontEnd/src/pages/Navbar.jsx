...
export default function Navbar() {
  ...
  const documentTools = [
    ...
    { name: "Word to PDF", id: "wordToPdf", icon: "fa-file-word", desc: "Turn a Word document into a PDF" },
    ...
    { name: "Excel to PDF", id: "excelToPdf", icon: "fa-file-excel", desc: "Turn a spreadsheet into a PDF" },
