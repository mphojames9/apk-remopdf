            ...
            {info.secondarySocial && (
              <div className="flex items-center gap-3">
                ...
                <span className="text-[11px] text-[#0f172a] font-medium">{info.secondarySocial}</span>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#0f172a] flex items-center justify-center shrink-0 text-white">
                      <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24"><path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10z"/></svg>
                    </div>
                    <div className="flex items-center gap-1.5 text-[11px] text-[#0f172a]">
                      <span className="font-bold text-[#c99c60] uppercase tracking-wider text-[9px]">DOB:</span>
                ...
                {info.nationality && (
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5 text-[11px] text-[#0f172a]">
                      <span className="font-bold text-[#c99c60] uppercase tracking-wider text-[9px]">Nationality:</span>
                      <span className="font-medium">{info.nationality}</span>
                    </div>
                  </div>
                )}
                {info.gender && (
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5 text-[11px] text-[#0f172a]">
                      <span className="font-bold text-[#c99c60] uppercase tracking-wider text-[9px]">Gender:</span>
                ...
                {info.drivingLicense && (
                  <div className="flex items-center gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#0f172a] flex items-center justify-center shrink-0 text-white">
                      <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24"><path d="M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14zm-9-9h7v2h-7zm0 4h7v2h-7zM5 8h5v6H5z"/></svg>
                    </div>
                    <div className="flex items-center gap-1.5 text-[11px] text-[#0f172a]">
                      <span className="font-bold text-[#c99c60] uppercase tracking-wider text-[9px]">License:</span>
                      <span className="font-medium">{info.drivingLicense}</span>
                    </div>
                  </div>)}
