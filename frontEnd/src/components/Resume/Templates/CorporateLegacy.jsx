      ...
      <aside className="w-[35%] bg-[#1A1C20] pt-12 pb-8 px-10 flex flex-col shrink-0 gap-5 border-r border-white/5 relative z-10">
        ...
        {info.github && (
          <div className="flex items-center gap-4 text-[12px]">
            ...
            <span className="font-light tracking-wide text-[#9BA0A6] break-all">{info.github.replace(/(^\w+:|^)\/\//, '')}</span>
          </div>
        )}
        ...
        {info.dob && (
          <div className="flex justify-between items-baseline">
             <span className="text-[12px] font-medium tracking-wide text-[#E0E2E5]">Date of Birth</span>
             <span className="text-[11px] text-[#8A8F96] font-light text-right">{info.dob}</span>
          </div>
        )}
        {info.nationality && (
          <div className="flex justify-between items-baseline">
             <span className="text-[12px] font-medium tracking-wide text-[#E0E2E5]">Nationality</span>
             <span className="text-[11px] text-[#8A8F96] font-light text-right">{info.nationality}</span>
          </div>
        )}
        {info.gender && (
          <div className="flex justify-between items-baseline">
             <span className="text-[12px] font-medium tracking-wide text-[#E0E2E5]">Gender</span>
             <span className="text-[11px] text-[#8A8F96] font-light text-right">{info.gender}</span>
          </div>
        )}
        {info.drivingLicense && (
          <div className="flex justify-between items-baseline">
             <span className="text-[12px] font-medium tracking-wide text-[#E0E2E5]">License</span>
             <span className="text-[11px] text-[#8A8F96] font-light text-right">{info.drivingLicense}</span>
          </div>
        )}
        ...
        {validSkills.map((skill, index) => {
          ...
          return (
            <div key={`skill-${index}`} className="items-center relative ml-0 pb-4 w-full">
              ...
              <div className="w-[180px] shrink-0 text-[13px] mb-2 text-[#E0E2E5] font-medium tracking-wide">
                {name}
              </div>
